...
namespace NerdStore.Vendas.Domain.Tests
{
    public class VoucherTests
    {
        ...
        {
            // Arrange
            var voucher = new Voucher("", null, null, 0, TipoDescontoVoucher.Valor,
        ...
        {
            // Arrange
            var voucher = new Voucher("PROMO-15-REAIS", 15, null, 1, TipoDescontoVoucher.Porcentagem,
                DateTime.Now.AddDays(15), true, false);
        ...
        {
            // Arrange
            var voucher = new Voucher("", null, null, 0, TipoDescontoVoucher.Porcentagem,
                DateTime.Now.AddDays(-1), false, true);
