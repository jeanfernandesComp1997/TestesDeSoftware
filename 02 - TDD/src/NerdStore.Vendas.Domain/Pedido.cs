...
namespace NerdStore.Vendas.Domain
{
    public class Pedido: Entity, IAggregateRoot
    {
        ...
        private void ValidarQuantidadeItemPermitidaNaAtualizacao(PedidoItem item)
        {
            if (item.Quantidade > MAX_UNIDADES_ITEM) throw new DomainException($"Máximo de {MAX_UNIDADES_ITEM} unidades por produto");
        }
        ...
        public void AtualizarItem(PedidoItem pedidoItem)
        {
            ...
            ValidarQuantidadeItemPermitidaNaAtualizacao(pedidoItem);
